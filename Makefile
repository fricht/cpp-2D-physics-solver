...
$(OUTPUT_DIR)/main: $(OUTPUT_DIR)/main.o $(OUTPUT_DIR)/particle.o $(OUTPUT_DIR)/forces.o $(OUTPUT_DIR)/constraints.o
	$(COMPILER) $(OUTPUT_DIR)/main.o $(OUTPUT_DIR)/particle.o $(OUTPUT_DIR)/forces.o $(OUTPUT_DIR)/constraints.o -o $(OUTPUT_DIR)/main $(CPP_FLAGS)
